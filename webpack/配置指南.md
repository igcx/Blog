...
# 在webpack环境中-组件的三种使用方式

## 局部组件

+ 在`components`中创建一个组件，`.vue`单文件组件
...
+ 在`pages`文件中创建页面级别的组件`Login.vue Register.vue`
...
vue官方提供了一个vue-cli工具， vue的脚手架， 可以非常轻松的搭建一个vue的项目结构
...
```js
vue create 02-vue-demo
```

+ 选择初始化什么类型的项目

![image-20200826094218778](/Users/x/Desktop/11-Vue/day11/01-教学资料/课堂笔记/images/image-20200826094218778.png)

==选择第三个==

+ 选择项目的功能

![image-20200826094940754](/Users/x/Desktop/11-Vue/day11/01-教学资料/课堂笔记/images/image-20200826094940754.png)

+ 选择vue版本

![image-20200826095056377](/Users/x/Desktop/11-Vue/day11/01-教学资料/课堂笔记/images/image-20200826095056377.png)

+ 是否使用路由的history模式

![image-20200826095333951](/Users/x/Desktop/11-Vue/day11/01-教学资料/课堂笔记/images/image-20200826095333951.png)

+ 选择less作为css的预处理器

![image-20200826095452348](/Users/x/Desktop/11-Vue/day11/01-教学资料/课堂笔记/images/image-20200826095452348.png)

+ 选择代码校验的风格

![image-20200826095634921](/Users/x/Desktop/11-Vue/day11/01-教学资料/课堂笔记/images/image-20200826095634921.png)

+ 选择校验的时机

![image-20200826095824170](/Users/x/Desktop/11-Vue/day11/01-教学资料/课堂笔记/images/image-20200826095824170.png)

+ 选择生成的配置文件的位置

![image-20200826095936023](/Users/x/Desktop/11-Vue/day11/01-教学资料/课堂笔记/images/image-20200826095936023.png)
